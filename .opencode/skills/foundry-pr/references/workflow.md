...
```
Skill(foundry:foundry-pr) "Create PR for spec my-feature-2025-11-03-001"
```
...
Once approved, the skill calls the MCP tool `foundry-mcp_pr action="create"`, which gathers spec context, journals, git diffs, and generates the PR description automatically (or performs a dry-run preview when requested).
