...
foundry-mcp_task action="query" spec_id={spec-id}

# Check spec location
foundry-mcp_spec action="find" spec_id={spec-id}
```
...
foundry-mcp_task action="complete" spec_id={spec-id} task_id={task-id} completion_note="..."

# Blocking
foundry-mcp_task action="block" spec_id={spec-id} task_id={task-id} reason="..."

# Unblocking
foundry-mcp_task action="unblock" spec_id={spec-id} task_id={task-id} resolution="..."
```
