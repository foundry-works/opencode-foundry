...
symbols = LSP(operation="documentSymbol", filePath="tests/test_auth.py", line=1, character=1)

# For key imports, verify targets exist
definition = LSP(operation="goToDefinition", filePath="tests/test_auth.py", line=5, character=1)
