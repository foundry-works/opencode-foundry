...
```bash
foundry-mcp_research action="deep-research" deep_research_action="start" query="Your research question" max_iterations=3 max_sub_queries=5 max_sources_per_query=5
```
...
**Critical:** The agent cannot implement timed delays between tool calls. Follow these patience rules instead.
