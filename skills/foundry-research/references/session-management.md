...
```bash
foundry-mcp_research action="thread-list" limit=10
foundry-mcp_research action="deep-research-list" limit=10
```
...
```bash
# List threads
foundry-mcp_research action="thread-list" limit=10 status="active"

# Get thread details
foundry-mcp_research action="thread-get" thread_id="thread-abc123"

# Delete thread
foundry-mcp_research action="thread-delete" thread_id="thread-abc123"
```
...
foundry-mcp_research action="deep-research-list" limit=10 completed_only=false

# Get session status
foundry-mcp_research action="deep-research-status" research_id="research-abc123"

# Get final report
foundry-mcp_research action="deep-research-report" research_id="research-abc123"

# Delete session
foundry-mcp_research action="deep-research-delete" research_id="research-abc123"
```
...
Invokes:
```bash
foundry-mcp_research action="chat" thread_id="thread-abc123" prompt="continue the discussion"
```
