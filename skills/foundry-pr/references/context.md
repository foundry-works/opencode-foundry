...
The skill analyzes several key sources (available via the MCP tool `foundry-mcp_pr action="context"`):
...
The MCP tool `foundry-mcp_journal action="list"` supplies recent entries (optionally scoped to a specific task).
