...
1. **Write Detailed Journal Entries**
   The AI uses journal entries to explain technical decisions, so capture the rationale as you work (the skill automatically pulls entries via `foundry-mcp_journal action="list"`).
